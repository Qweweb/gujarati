...
export const THEMES = {
  default: {
    ...
    tools: [
      ...
      { cat:'utilities', icon:'sports_esports',   label:'રમતો',    path:'/games',                bg:'#FEF2F2', iconBg:'#F43F5E', iconClr:'#fff' },
  ...
  theme1: {
    ...
    tools: [
      ...
      { cat:'utilities', icon:'sports_esports',   label:'રમતો',    path:'/games',                bg:'transparent', iconBg:'#F8FAFC', iconClr:'#2D3748', border:'1px solid #E8E6E3' },
  ...
  theme2: {
    ...
    tools: [
      ...
      { cat:'utilities', icon:'sports_esports',   label:'રમતો',    path:'/games',                bg:'transparent', iconBg:'#F8FAFC', iconClr:'#4C1D95', border:'1px solid #E8E6E3' },
  ...
  theme3: {
    ...
    tools: [
      ...
      { cat:'utilities', icon:'sports_esports',   label:'રમતો',    path:'/games',                bg:'#FFF7ED', iconBg:'#F08833', iconClr:'#fff' },
  ...
  theme4: {
    ...
    tools: [
      ...
      { cat:'utilities', icon:'sports_esports',   label:'રમતો',    path:'/games',                bg:'#FDF8F2', iconBg:'#8C6239', iconClr:'#fff' },
