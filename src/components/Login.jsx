        ...
        <div className="w-full max-w-sm relative z-10 flex flex-col items-center">
            ...
            <div className="w-full bg-surface dark:bg-stone-900 rounded-[2rem] p-8 shadow-sm border border-outline dark:border-stone-800 space-y-6">
                ...
                <button
                    ...
                    className="w-full group relative flex items-center justify-center gap-4 py-4 px-6 rounded-xl bg-background dark:bg-stone-800 text-brand-600 dark:text-stone-100 font-gujarati font-bold text-lg transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 border border-primary/30 overflow-hidden"
                >
                    ...
                    <span className="relative z-10" style={{ fontFamily: '"Noto Serif Gujarati", serif' }}>Google થી લોગિન કરો</span>
                </button>
