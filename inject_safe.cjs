...
const startMarker = "{/* Panchang Hero Row — horizontal scroll */}";
...
const replacement = `{/* Combined Panchang & Choghadiya Hero Card */}
...
fs.writeFileSync('src/components/Dashboard.jsx', newContent);
console.log("Successfully replaced cards with combined card");
