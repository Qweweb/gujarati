...
const headerTarget = `<Link to="/" style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', gap:8, textDecoration:'none' }}>
...
const headerReplacement = `<Link to="/" style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', textDecoration:'none' }}>
          <img 
...
const sidebarTarget = `<div style={{ display:'flex', alignItems:'center', gap:8 }}>
...
const sidebarReplacement = `<div style={{ display:'flex', alignItems:'center' }}>
                <img 
                  src={darkMode ? "/logo-light.png" : "/logo-dark.png"} 
                  alt="Gujarati App" 
                  style={{ height: '36px', objectFit: 'contain' }} 
